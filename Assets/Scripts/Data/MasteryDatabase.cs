...
namespace Data{
    ...
    public class MasteryDatabase : ScriptableObject{
        ...
        [Header("Mastery Registry")] [Tooltip("The backing list of all generated Mastery ScriptableObjects. Hidden in inspector, populated automatically by the Google Sheets importer.")] [SerializeField]
