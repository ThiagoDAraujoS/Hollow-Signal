...
namespace Core.Config{
    ...
    public class SceneDependencyDatabase : ScriptableObject{
        ...
        /// Retrieves required save data partition files for the specified scene.
        public List<string> GetSceneDependencies(string sceneName){
            foreach (SceneDependencies dep in dependencies)
                if (string.Equals(dep.sceneName, sceneName, StringComparison.OrdinalIgnoreCase))
